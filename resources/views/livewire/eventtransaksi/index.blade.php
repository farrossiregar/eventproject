                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                ...
                                                @endif
                                                <a href="route('eventtransaksi.items',$item->id)" class="dropdown-item"><i class="fa fa-info"></i> Detail</a>
                                            </div>
                                        </div>    
                                    </td>
                                </tr>
                            ...
                            <table class="table">
                                ...
                                @if(count(array_filter($check_id))>1)
                                    @foreach(\App\Models\Transaksi::whereIn('id',$check_id)->get() as $k => $item)
                                        <tr>
                                            <td>{{$k+1}}</td>
                                            <td><a href="route('eventtransaksi.items',$item->id)" target="_blank">{{$item->no_transaksi}}</a></td>
                                            <td>{{date('d-M-Y H:i',strtotime($item->created_at))}}</td>
                                            <td class="text-right">{{format_idr($item->amount)}}</td>
                                        </tr>
                                    @endforeach
...
<div class="modal fade" id="modal_upload" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <!-- livewire:eventtransaksi.upload / -->
        </div>
    </div>
</div>
